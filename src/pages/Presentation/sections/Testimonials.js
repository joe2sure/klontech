  ...
  return (
    <MKBox component="section" py={12}>
      <Container>
        ...
        >
          <MKTypography variant="h2">Trusted by Innovators</MKTypography>
          <MKTypography variant="h2" color="info" textGradient mb={2}>
            Worldwide
          </MKTypography>
          <MKTypography variant="body1" color="text" mb={2}>
            Join the ranks of leading businesses and individuals transforming their future with our solutions.
          </MKTypography>
        </Grid>
        <Grid container spacing={3} sx={{ mt: 8 }}>
          <Grid item xs={12} md={6} lg={4}>
            <DefaultReviewCard
              name="John Doe"
              date="1 day ago"
              review="Klontek's AI solutions have revolutionized our business operations. Highly recommended!"
              rating={5}
            />
          </Grid>
          <Grid item xs={12} md={6} lg={4}>
            <DefaultReviewCard
              ...
              name="Jane Smith"
              date="1 week ago"
              review="The blockchain development team is exceptional. They delivered beyond our expectations."
              rating={5}
            />
          </Grid>
          <Grid item xs={12} md={6} lg={4}>
            <DefaultReviewCard
              name="Alice Johnson"
              date="3 weeks ago"
              review="Their Web3 integration services are top-notch. A game-changer for our platform."
              rating={5}
            />
          </Grid>
        </Grid>
